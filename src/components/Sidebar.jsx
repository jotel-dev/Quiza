...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 border-r border-slate-100 p-5 shrink-0 bg-white/50 backdrop-blur-md">
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all
                ${isActive
                  ? "bg-[#0A4C86] text-white shadow-md shadow-blue-200"
      ...
      <GlassCard className="p-4 mt-4 text-center bg-gradient-to-b from-blue-50 to-white">
        <div className="w-14 h-14 mx-auto mb-2 rounded-full bg-[#F26722]/15 flex items-center justify-center">
          <Trophy size={26} className="text-[#F26722]" />
        </div>
        ...
        <button 
          ...
          className="mt-3 w-full bg-[#0A4C86] text-white text-xs font-semibold py-2.5 rounded-xl hover:opacity-90 transition active:scale-95"
        >
          Start Quiz Now →
        </button>
      </GlassCard>
